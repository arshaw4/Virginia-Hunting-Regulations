...
class ResultScreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tealResults).text = tealResults(calendar, tealValue, i95ZoneSwitchValue)
        findViewById<TextView>(R.id.mergansersResults).text = mergansersResults(calendar, mergansersValue)
    }
